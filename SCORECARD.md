...
|---|---|
| Hollow Crown | |
| Hollow Crown: Ashen Tide | |
| Emberwatch Tactics | |
| Saltmarsh Rally | |
| Lantern & Lock | |
| **Company total, FY2026 Q2** | |

## 2. Cash settled in December 2025

| | Value |
|---|---|
| Net revenue settled in Dec 2025 | |

## 3. Refunds in December 2025, as Treasury counts them

| | Value |
|---|---|
| Refunds recognised in Dec 2025 | |
...
|---|---|
| Twin Hearth Studios | |
| Emberwatch Interactive | |
| Nine Lanterns | |
| Saltpine Games | |
| **Sum of the four rows above** | |
| **Company net revenue, FY2026** | |
